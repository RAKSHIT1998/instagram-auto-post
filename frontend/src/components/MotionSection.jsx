...
export default function MotionSection({ eyebrow, title, description }) {
  ...
  return (
    <section ref={ref} className="min-h-[70vh] flex items-center justify-center px-4 md:px-8">
      <motion.div style={{ y, opacity, scale }} className="glass-card max-w-4xl w-full p-8 md:p-14">
